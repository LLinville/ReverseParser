...
{
<start> 
<paragraph> <paragraph> <paragraph> <paragraph> <section-ext> 	;
}
...
by means of <Ns> 	;
in the study of <Ns> 	;
therefore, with the sole exception of <Ns> , 	;
certainly	;
still	;
...
{
<paragraph> 
        <sentence>   <sentence> <opt-sentence> <sentence> <opt-question> <opt-sentence> <opt-sentence> <opt-sentence> <sentence> <opt-throwaway> 	;
        <sentence>   <sentence> <opt-sentence>   <sentence>   ( <sentence> ) <sentence>   <sentence> <opt-throwaway> 	;
        <sentence>   <sentence> <opt-sentence> <sentence> <opt-sentence> <opt-sentence> <opt-sentence>   <sentence> 	;
}
...
{
<question> 
Whence comes <Ns>  , the solution of which involves the relation between <NsNp>  and <NsNp> ?	;
<opt-intro-clause> is it the case that <Ns>  <Vst>  <NsNp>  , or is the real question whether <Np>  <Vpi> ?	;
Has it ever been suggested the <opt-proof>  <certainty-clause>  there is a causal connection between <NsNp>  and <NsNp> ?	;
...
may not contradict itself, but it is still possible that it may be in contradiction with	;
...
is a body of demonstrated doctrine, and <quantity>  it must be known <knowledge-type> 	;
...
{
<Vpi> 
are the mere results of the power of <Ns>  , a blind but indispensible function of the soul	;
...
{
<throwaway-sentence> 
But we have fallen short of the necessary interconnection that we have in mind when we speak of <NsNp> .	;
